...
for imgPath in targetImages:
	for tvalue in tvalues:
		logDir = "../analysis/T" + str(tval) + "/"

		for editMode in editModes:
			call (exe + "--preload" + scene + "--auto " + str(editMode) + " --img-attr " + imgPath + " --more --samples 200 --out " + logDir + " --jnd 0.1 --timeout 4")
