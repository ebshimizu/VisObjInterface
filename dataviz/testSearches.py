...
for imgPath in targetImages:
	call(exe + " --preload " + scene + " --auto 0 --img-attr " + imgPath + " --more --samples 200 --out C:/Users/eshimizu/Documents/AttributesInterface/logs/ --jnd 3 --timeout 4 --ev-weight 0.7")
	...
	call(exe + " --preload " + scene + " --auto 4 --img-attr " + imgPath + " --more --samples 200 --out C:/Users/eshimizu/Documents/AttributesInterface/logs/ --jnd 3 --timeout 4 --ev-weight 0.7")
	call(exe + " --preload " + scene + " --auto 5 --img-attr " + imgPath + " --more --samples 200 --out C:/Users/eshimizu/Documents/AttributesInterface/logs/ --jnd 3 --timeout 4 --ev-weight 0.7")
	call(exe + " --preload " + scene + " --auto 6 --img-attr " + imgPath + " --more --samples 200 --out C:/Users/eshimizu/Documents/AttributesInterface/logs/ --jnd 3 --timeout 4 --ev-weight 0.7")
	call(exe + " --preload " + scene + " --auto 7 --img-attr " + imgPath + " --more --samples 200 --out C:/Users/eshimizu/Documents/AttributesInterface/logs/ --jnd 3 --timeout 4 --ev-weight 0.7")

call("python processData.py ../logs/")
