...
NoireAttribute::NoireAttribute() : HistogramAttribute("Noir")
{
...
double NoireAttribute::evaluateScene(Snapshot * s, Image& img)
{
  ...
  Histogram1D brightness = getGrayscaleHist(img, 100);
