...
SettingsEditor::SettingsEditor()
{
  Array<PropertyComponent*> searchComponents;
	searchComponents.add(new SettingsChoice("Search Mode", { "MCMC with Edits", "Levenberg-Marquardt", "Hybrid Explore", "Hybrid Debug", "MCMC with Edits and Levenberg-Marquardt Refinement" }));
